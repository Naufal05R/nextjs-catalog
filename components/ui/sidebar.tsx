...
import { ArchiveX, AudioWaveform, Boxes, Command, GalleryVerticalEnd, Newspaper, PanelLeft } from "lucide-react";
...
type SidebarContext = {
  ...
  isMobile: boolean;
  toggleSidebar: () => void;
  navigations: typeof initialNavigations;
  setNavigations: React.Dispatch<React.SetStateAction<typeof initialNavigations>>;
};
...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const [navigations, setNavigations] = React.useState(initialNavigations);
  ...
  const contextValue = React.useMemo<SidebarContext>(
    ...
    [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, navigations],
  );
